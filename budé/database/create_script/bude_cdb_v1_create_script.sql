...
-- Schema bude_cdb_v1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bude_cdb_v1` DEFAULT CHARACTER SET utf8 ;
USE `bude_cdb_v1` ;

-- -----------------------------------------------------
-- Table `bude_cdb_v1`.`locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bude_cdb_v1`.`locations` (
...
-- -----------------------------------------------------
-- Table `bude_cdb_v1`.`correspondents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bude_cdb_v1`.`correspondents` (
  ...
  CONSTRAINT `fk_persons_groups_bodies_locations1`
    ...
    REFERENCES `bude_cdb_v1`.`locations` (`locations_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `bude_cdb_v1`.`letters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bude_cdb_v1`.`letters` (
  ...
  CONSTRAINT `fk_letters_correspondents1`
    ...
    REFERENCES `bude_cdb_v1`.`correspondents` (`correspondents_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
