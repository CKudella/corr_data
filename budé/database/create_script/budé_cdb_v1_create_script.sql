...
-- Schema budé_cdb_v1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `budé_cdb_v1` DEFAULT CHARACTER SET utf8 ;
USE `budé_cdb_v1` ;

-- -----------------------------------------------------
-- Table `budé_cdb_v1`.`locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `budé_cdb_v1`.`locations` (
...
-- -----------------------------------------------------
-- Table `budé_cdb_v1`.`correspondents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `budé_cdb_v1`.`correspondents` (
  ...
  `gender` VARCHAR(45) NULL COMMENT 'This column classifies the gender (male/female) of the correspondent if the latter is an individual. For corporate bodies and groups, this column contains the value ‘unapplicable’.',
  `viaf_id` VARCHAR(45) NULL COMMENT 'This column carries for correspondents that are individuals the numeric identifier provided by VIAF. For corporate bodies and groups, this column contains the value ‘unapplicable’.',
  ...
  `dob_annotion` VARCHAR(200) NULL COMMENT 'This column carries the date of birth as it appears in the source of this information.',
  `dob_annotion_ref` VARCHAR(200) NULL COMMENT 'This column carries a reference to the source of the information contained in ‘dob_annotation’.',
  ...
  `dod_annotion` VARCHAR(90) NULL COMMENT 'This column carries a reference to the source of the information contained in ‘dod_annotation’.',
  `dod_annotion_ref` VARCHAR(200) NULL COMMENT 'This Column holds the bibliographic reference for the text in persons_groups_bodies_dod_annotion, e.g. \"Collected Works of Erasmus, Vol. 1, p. 3\"',
  ...
  CONSTRAINT `fk_persons_groups_bodies_locations1`
    ...
    REFERENCES `budé_cdb_v1`.`locations` (`locations_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `budé_cdb_v1`.`letters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `budé_cdb_v1`.`letters` (
  ...
  CONSTRAINT `fk_letters_correspondents1`
    ...
    REFERENCES `budé_cdb_v1`.`correspondents` (`correspondents_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
