SELECT X.LocationName,
       X.Latitude,
       X.Longitude,
       X.NoLettersFROMBudéTO AS 'Number of letters written by Budé to this location',
       Y.NoLettersBYBudéAT AS 'Number of letters written by Budé at this location'
FROM
  (SELECT XB.locations_name_modern AS LocationName,
          XB.locations_lat AS 'Latitude',
          XB.locations_lng AS 'Longitude',
          COUNT(XA.target_loc_id) AS NoLettersFROMBudéTO
