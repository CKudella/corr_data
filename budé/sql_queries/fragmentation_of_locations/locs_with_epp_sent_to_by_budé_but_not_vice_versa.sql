SELECT DISTINCT A.target_loc_id,
...
LEFT JOIN bude_cdb_v1.locations AS SourceLoc ON SourceLoc.locations_id = A.source_loc_id
LEFT JOIN bude_cdb_v1.locations AS TargetLoc ON TargetLoc.locations_id = A.target_loc_id
WHERE A.sender_id = 'c0b89c75-45b8-4b04-bfd7-25bfe9ed040b'
  AND A.target_loc_id NOT IN
    (SELECT DISTINCT B.source_loc_id
