...
LEFT OUTER JOIN
  (SELECT XB.locations_id,
   ...
   JOIN bude_cdb.locations AS XB ON XB.locations_id = XA.source_loc_id
...
LEFT OUTER JOIN
  (SELECT YB.locations_id,
   ...
   JOIN bude_cdb.locations AS YB ON YB.locations_id = YA.target_loc_id
