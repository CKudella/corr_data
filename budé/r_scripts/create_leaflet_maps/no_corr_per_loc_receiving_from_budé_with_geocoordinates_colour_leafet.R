...
# Determine breaks
median_val <- median(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, na.rm = TRUE)
q1 <- quantile(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, 0.25, na.rm = TRUE)
q3 <- quantile(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, 0.75, na.rm = TRUE)
box_stats <- boxplot.stats(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé)
...
num_breaks <- 5
breaks <- classIntervals(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, n = num_breaks, style = "jenks")$brks
breaks[1] <- min(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, na.rm = TRUE)
breaks[6] <- max(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, na.rm = TRUE)
...
data$class <- findInterval(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, breaks, rightmost.closed = TRUE)
...
m <- m %>%
  addControl(
    html = "<div style='width: 100%; text-align: center;'>
              ...
              Number of correspondents at this location to whom Budé wrote letters</h3>
            </div>",
    position = "topright"
  )
...
saveWidget(m, file = "no_corr_per_loc_receiving_from_budé_with_geocoordinates_colour.html", selfcontained = TRUE)
