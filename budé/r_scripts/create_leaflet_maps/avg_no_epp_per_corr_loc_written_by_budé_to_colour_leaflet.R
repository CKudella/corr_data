...
# Read data
data <- read.csv("no_epp_per_loc/avg_no_epp_per_corr_loc_written_by_budé_to.csv", fileEncoding = "UTF-8", na.strings = c("NULL"))
...
m <- m %>%
  addControl(
    html = "<div style='width: 100%; text-align: center;'>
              ...
              Average number of letters sent by Budé to this location per correspondent</h3>
            </div>",
    position = "topright"
  )
...
saveWidget(m, file = "avg_no_epp_per_corr_loc_written_by_budé_to_colour.html", selfcontained = TRUE)
