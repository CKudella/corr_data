...
breaks <- c(min(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, na.rm = TRUE), 
            q3, outliers, max(data$Number.of.correspondents.who.received.at.this.location.letters.from.Budé, na.rm = TRUE))
...
saveWidget(m, file = "no_corr_per_loc_receiving_from_budé_with_geocoordinates_outliers_colour.html", selfcontained = TRUE)
