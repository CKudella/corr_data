...
plot <- ggplot(data=data, aes(x= Year, y=Number.of.correspondents.receiving.letters.from.Budé.this.year)) +
...
plot2 <- ggplot(data=data, aes(x= Year, y=Number.of.letters.sent.from.Budé.this.year)) +
  geom_line(stat = "identity", size=0.9) +
