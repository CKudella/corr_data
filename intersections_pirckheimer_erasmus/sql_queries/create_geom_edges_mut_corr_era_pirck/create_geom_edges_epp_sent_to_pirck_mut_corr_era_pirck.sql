...
LEFT JOIN wpirck_cdb.locations AS SourceLoc ON SourceLoc.locations_id = L.source_loc_id
LEFT JOIN wpirck_cdb.locations AS TargetLoc ON TargetLoc.locations_id = L.target_loc_id
