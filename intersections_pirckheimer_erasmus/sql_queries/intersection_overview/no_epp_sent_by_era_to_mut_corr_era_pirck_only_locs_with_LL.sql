SELECT COUNT(*) AS 'Total number of letters sent from Erasmus to mutual correspondents of his and and Pirckheimer (only letters with source and target locations with geocoordinates)'
FROM
  (SELECT *
