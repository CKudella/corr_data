SELECT DISTINCT locations.locations_modern_state AS 'Modern State',
                COUNT(DISTINCT recipient_id) AS 'Number of mutual correspondents of Erasmus and Pirckheimer who received letters from Pirckheimer in this modern state'
FROM wpirck_cdb.letters,
     wpirck_cdb.locations
