...
nodes <- read.csv("time_slice_1514_complete_merge_pirck_and_era_correspondents.csv", fileEncoding="UTF-8")
links <- read.csv("time_slice_1514_complete_merge_pirck_and_era_letters_corr_as_nodes.csv", fileEncoding="UTF-8")[ ,c('Source', 'Target')]
