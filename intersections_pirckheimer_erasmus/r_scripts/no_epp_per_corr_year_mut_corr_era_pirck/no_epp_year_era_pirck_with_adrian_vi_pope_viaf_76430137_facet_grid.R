...
ggsave("no_epp_year_era_pirck_with_adrian_vi_pope_viaf_76430137_facet_grid.pdf", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
