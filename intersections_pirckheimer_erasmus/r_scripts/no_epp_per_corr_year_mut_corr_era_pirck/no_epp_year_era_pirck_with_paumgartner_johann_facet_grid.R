...
# set labels
labels <- c(EPPEtX = "Erasmus to Johann (II) PAUMGARTNER", EPPXtE = "Johann (II) PAUMGARTNER to Erasmus", EPPPtX = "Pirckheimer to Johann (II) PAUMGARTNER", EPPXtP = "Johann (II) PAUMGARTNER to Pirckheimer")
