...
# read data
data<-read.csv("no_epp_per_corr_year_mut_corr_era_pirck/no_epp_year_era_pirck_with_capito_wolfgang_viaf_61578502.csv", fileEncoding="UTF-8", na.strings=c("NULL"))
