...
gexf_file <- file.path("..", "network_data", "intersection_merge_retrospective_gexf_created_by_r", "intersection_merge_pirck_and_era.gexf")

# create the description for the gexf metadata
description <- "A graph representing the intersection merge of Erasmus's and Pirckheimer's networks of correspondence."
