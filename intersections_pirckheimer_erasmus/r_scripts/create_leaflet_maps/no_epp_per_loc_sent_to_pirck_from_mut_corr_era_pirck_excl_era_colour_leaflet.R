...
num_breaks <- 3
breaks <- classIntervals(data$Number.of.letters.sent.from.this.location.to.Pirckheimer.from.mutual.correspondents.of.his.and.Erasmus..excl..Erasmus, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_epp_per_loc_sent_to_pirck_from_mut_corr_era_pirck_excl_era_colour.html", selfcontained = TRUE)
