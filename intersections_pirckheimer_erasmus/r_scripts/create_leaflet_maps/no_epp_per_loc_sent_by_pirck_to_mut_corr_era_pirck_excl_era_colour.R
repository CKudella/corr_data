...
num_breaks <- 3
breaks <- classIntervals(data$Number.of.letters.sent.to.this.location.by.Pirckheimer.to.mutual.correspondents.of.his.and.Erasmus..excl..Erasmus, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_epp_per_loc_sent_by_pirck_to_mut_corr_era_pirck_excl_era_colour.html", selfcontained = TRUE)
