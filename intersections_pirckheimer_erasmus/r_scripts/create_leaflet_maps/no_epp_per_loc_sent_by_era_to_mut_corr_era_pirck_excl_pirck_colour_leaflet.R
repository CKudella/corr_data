...
num_breaks <- 4
breaks <- classIntervals(data$Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Pirckheimer..excl..Pirckheimer, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_epp_per_loc_sent_by_era_to_mut_corr_era_pirck_excl_pirck_colour.html", selfcontained = TRUE)
