...
num_breaks <- 3
breaks <- classIntervals(data$Number.of.letters.sent.from.this.location.to.Erasmus.from.mutual.correspondents.of.his.and.Pirckheimer..excl..Pirckheimer, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_epp_per_loc_sent_to_era_from_mut_corr_era_pirck_excl_pirck_colour.html", selfcontained = TRUE)
