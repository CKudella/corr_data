SELECT COUNT(*) AS 'Total number of letters sent by Erasmus to mutual correspondents of his and and Budé (only letters with source and target locations with geocoordinates)'
FROM
  (SELECT *
