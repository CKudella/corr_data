...
LEFT JOIN era_cdb_v3.locations AS SourceLoc ON SourceLoc.locations_id = L.source_loc_id
LEFT JOIN era_cdb_v3.locations AS TargetLoc ON TargetLoc.locations_id = L.target_loc_id
