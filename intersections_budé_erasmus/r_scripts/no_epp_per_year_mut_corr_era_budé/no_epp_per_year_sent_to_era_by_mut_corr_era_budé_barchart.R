...
# create bar chart
plot <- ggplot(data=data, aes(x=send_date_year1,y= Total.number.of.letters.sent.to.Erasmus.this.year.by.mutual.correspondents.of.his.and.Budé..excl..Budé.)) +
  geom_bar(stat = "identity") +
  labs(x="Year",y="Number of letters sent to Erasmus by mutual correspondents") +
  geom_text(aes(label=Total.number.of.letters.sent.to.Erasmus.this.year.by.mutual.correspondents.of.his.and.Budé..excl..Budé.), vjust=-0.5, color='black') +
