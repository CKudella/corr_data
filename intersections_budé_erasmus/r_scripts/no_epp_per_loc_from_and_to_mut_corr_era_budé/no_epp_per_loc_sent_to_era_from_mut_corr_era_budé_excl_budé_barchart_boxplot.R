...
# calculate quartiles
quartiles <- as.numeric(quantile(data$Number.of.letters.sent.from.this.location.to.Erasmus.from.mutual.correspondents.of.his.and.Budé..excl..Budé., probs = c(0.25, 0.5, 0.75)))
...
ggsave("no_epp_per_loc_sent_to_era_from_mut_corr_era_budé_excl_budé_barchart_boxplot.pdf", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("no_epp_per_loc_sent_to_era_from_mut_corr_era_budé_excl_budé_barchart_boxplot.png", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("no_epp_per_loc_sent_to_era_from_mut_corr_era_budé_excl_budé_barchart_boxplot.eps", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("no_epp_per_loc_sent_to_era_from_mut_corr_era_budé_excl_budé_barchart_boxplot.svg", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
