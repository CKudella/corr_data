...
plot1 <- ggplot(data, aes(x= reorder(Location.Name.Modern, -Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Budé..excl..Budé.),y=Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Budé..excl..Budé.)) +
  ...
  labs(x="Locations",y="Number of letters written by Erasmus to mutual correspondents (excluding letters to Budé)") +
  theme_bw() +
...
plot2 <- ggplot(data, aes(x= ' ', y = Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Budé..excl..Budé.)) +
  ...
  geom_hline(aes(yintercept = mean(Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Budé..excl..Budé.), linetype = "mean"), size = 0.3) +
  geom_hline(aes(yintercept = median(Number.of.letters.sent.to.this.location.by.Erasmus.to.mutual.correspondents.of.his.and.Budé..excl..Budé.), linetype = "median"), size = 0.3) +
  ...
  theme_bw() +
  theme(axis.title.x=element_blank()) +
  labs(y = "Number of letters written by Erasmus to mutual correspondents (excluding letters to Budé)")
plot2
