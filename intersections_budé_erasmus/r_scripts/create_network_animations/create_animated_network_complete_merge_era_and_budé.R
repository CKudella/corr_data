...
render.d3movie(network, slice.par = slice.par, displaylabels = FALSE, animation.mode = "kamadakawai", bg = "#f7f7f7", vertex.col = "vertex.col", vertex.cex = "vertex.cex", vertex.lwd = 2, vertex.tooltip = function(slice){paste0(slice %v% 'vertex.names')},edge.col = "edge.col", edge.lwd = 2 + get.edge.attribute(network, "edge.weight"), output.mode = "HTML", script.type = "embedded", filename = "animated_network_complete_era_budé.html")

# render animation and export to an animated GIF file
saveGIF(render.animation(network, slice.par = slice.par, displaylabels = FALSE, animation.mode = "kamadakawai", bg = "#f7f7f7", vertex.col = "vertex.col", vertex.cex = "vertex.cex", vertex.lwd = 2, edge.col = "edge.col", edge.lwd = 2 + get.edge.attribute(network, "edge.weight")), movie.name = "animated_network_complete_era_budé.gif", ani.width = 1280, ani.height = 720)
