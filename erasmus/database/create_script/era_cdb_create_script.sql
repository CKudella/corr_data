...
-- Schema era_cdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `era_cdb` DEFAULT CHARACTER SET utf8 ;
USE `era_cdb` ;

-- -----------------------------------------------------
-- Table `era_cdb`.`locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb`.`locations` (
...
-- -----------------------------------------------------
-- Table `era_cdb`.`correspondents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb`.`correspondents` (
  ...
  CONSTRAINT `fk_persons_groups_bodies_locations1`
    ...
    REFERENCES `era_cdb`.`locations` (`locations_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `era_cdb`.`letters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb`.`letters` (
  ...
  CONSTRAINT `fk_letters_correspondents1`
    ...
    REFERENCES `era_cdb`.`correspondents` (`correspondents_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
