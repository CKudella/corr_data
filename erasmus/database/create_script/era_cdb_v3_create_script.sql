...
-- Schema era_cdb_v3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `era_cdb_v3` DEFAULT CHARACTER SET utf8 ;
USE `era_cdb_v3` ;

-- -----------------------------------------------------
-- Table `era_cdb_v3`.`locations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb_v3`.`locations` (
...
-- -----------------------------------------------------
-- Table `era_cdb_v3`.`correspondents`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb_v3`.`correspondents` (
  ...
  CONSTRAINT `fk_persons_groups_bodies_locations1`
    ...
    REFERENCES `era_cdb_v3`.`locations` (`locations_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `era_cdb_v3`.`letters`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `era_cdb_v3`.`letters` (
  ...
  CONSTRAINT `fk_letters_correspondents1`
    ...
    REFERENCES `era_cdb_v3`.`correspondents` (`correspondents_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
