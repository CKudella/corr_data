SELECT COUNT(correspondents_id) AS 'Total number of correspondents for whom the dataset contains only letters written to them from Erasmus but not vice versa'
