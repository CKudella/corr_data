...
correspondents_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/era_correspondents.csv'))
letters_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/era_letters.csv'))
locations_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/era_locations.csv'))
