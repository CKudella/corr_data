...
data_path <- "../query_results/no_epp_per_year/no_epp_per_day_sent_by_era.csv"
output_path <- "../r_plots/no_epp_per_year/no_epp_per_day_sent_by_era_facet_grid"

measure_col   <- "NoEppSentFromEra"
...
plot_facets <- data |>
  ...
  labs(
    title = str_glue("Letters sent BY {subject_name}, by day, month, and year"),
    x = "Day of month",
    y = "Number of letters"
  ) +
