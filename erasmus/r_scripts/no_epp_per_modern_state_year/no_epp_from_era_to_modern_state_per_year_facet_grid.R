...
plot <- ggplot(data = data, aes(x = Year, y = Number.of.letters.Erasmus.sent.to.this.modern.state.this.year)) +
  geom_bar(stat = "identity") +
  labs(x = "Year", y = "Number of letters sent by Erasmus to this modern state") +
