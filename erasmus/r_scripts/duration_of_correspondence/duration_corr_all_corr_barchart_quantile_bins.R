...
data_path <- "../query_results/duration_of_correspondence/duration_corr_all_corr.csv"
output_path <- "../r_plots/duration_of_correspondence/duration_corr_all_corr_barchart_quantile_bins"
