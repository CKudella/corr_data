...
# create box plot
plot1 <- ggplot(duration_of_correspondence_only_epp_from_erasmus, aes(x = " ", y = duration_in_years)) +
...
# create density plot
plot2 <- ggplot(duration_of_correspondence_only_epp_from_erasmus, aes(x = duration_in_years)) +
...
plot3 <- ggplot(duration_of_correspondence_only_epp_from_erasmus, aes(x = duration_in_years)) +
...
# create scatter plot
plot4 <- ggplot(duration_of_correspondence_only_epp_from_erasmus, aes(x = Beginning.of.the.correspondence ,y = duration_in_years)) +
...
ggsave("duration_of_correspondence_only_epp_from_era_plots_combined.pdf", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_era_plots_combined.png", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_era_plots_combined.eps", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_era_plots_combined.svg", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
