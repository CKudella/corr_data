...
duration_of_correspondence_only_epp_to_erasmus$duration_in_years <- round(duration_of_correspondence_only_epp_to_erasmus$duration_in_years, digits = 1)
...
# create density plot
plot <- ggplot(duration_of_correspondence_only_epp_to_erasmus, aes(x = duration_in_years)) +
...
ggsave("duration_of_correspondence_only_epp_to_era_density_plot.pdf", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_to_era_density_plot.png", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_to_era_density_plot.eps", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_to_era_density_plot.svg", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
