...
data_path <- "../query_results/no_corr_per_modern_state/no_corr_per_modern_state_writing_epp_to_era.csv"
output_path <- "../r_plots/no_corr_per_modern_state/no_corr_per_modern_state_writing_epp_to_era_barchart"

measure_col <- str_glue("Number of correspondents who wrote letters to {subject_name}")
...
plot_barchart <- data |>
  ...
  labs(
    title = str_glue("Number of correspondents per modern state who wrote letters to {subject_name}"),
