...
data_path   <- "../query_results/no_epp_per_loc/avg_no_epp_per_corr_loc_written_by_era_to.csv"
output_path <- "../leaflet_maps/avg_no_epp_per_corr_loc_written_by_era_to_colour.html"

measure_col  <- "Average Number of letters per correspondent"
...
description <- str_glue("Average number of letters sent by {subject_name} per correspondent")
