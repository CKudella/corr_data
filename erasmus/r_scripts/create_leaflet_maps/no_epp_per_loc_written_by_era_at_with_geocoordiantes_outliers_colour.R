...
data_path   <- "../query_results/no_epp_per_loc/no_epp_per_loc_written_by_era_at_with_geocoordiantes.csv"
output_path <- "../leaflet_maps/no_epp_per_loc_written_by_era_at_with_geocoordiantes_outliers_colour.html"
...
description <- str_glue("Number of letters written by {subject_name} at this location")
