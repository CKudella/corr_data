...
output_path <- "../leaflet_maps/avg_no_epp_per_loc_year_written_by_era_at_colour.html"
...
description <- str_glue("Average number of letters written by {subject_name} at this location per year")
