...
data_path   <- "../query_results/no_epp_per_loc/no_epp_per_loc_sent_to_era_with_geocoordinates.csv"
output_path <- "../leaflet_maps/no_epp_per_loc_sent_to_era_with_geocoordinates_outliers_colour.html"
...
description <- str_glue("Number of letters sent to {subject_name} from this location")
