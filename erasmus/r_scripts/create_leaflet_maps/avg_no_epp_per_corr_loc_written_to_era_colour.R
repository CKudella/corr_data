...
output_path <- "../leaflet_maps/avg_no_epp_per_corr_loc_written_to_era_colour.html"
...
description <- str_glue("Average number of letters sent to {subject_name} from this location per correspondent")
