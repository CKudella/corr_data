...
num_breaks <- 4
breaks <- classIntervals(data$Number.of.correspondents.who.wrote.from.this.location.letters.to.Erasmus, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_corr_per_loc_writing_to_era_with_geocoordinates_colour.html", selfcontained = TRUE)
