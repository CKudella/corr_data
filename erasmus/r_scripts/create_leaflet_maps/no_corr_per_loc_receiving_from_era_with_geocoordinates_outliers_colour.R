...
output_path <- "../leaflet_maps/no_corr_per_loc_receiving_from_era_with_geocoordinates_outliers_colour.html"
...
description <- str_glue("Number of correspondents at this location to whom {subject_name} wrote letters")
