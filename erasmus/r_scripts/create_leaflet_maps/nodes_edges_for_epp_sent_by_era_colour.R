...
nodes_path       <- "../query_results/create_geolayout_files_for_gephi/nodes_edges_for_epp_sent_by_era/create_nodes_locations_for_epp_sent_by_era.csv"
edges_path       <- "../query_results/create_geolayout_files_for_gephi/nodes_edges_for_epp_sent_by_era/create_edges_epp_sent_by_era.csv"
breaks_data_path <- "../query_results/no_epp_per_loc/no_epp_per_loc_sent_by_era_to_with_geocoordinates.csv"
output_path      <- "../leaflet_maps/nodes_edges_for_epp_sent_by_era_colour.html"

measure_col  <- str_glue("Number of letters sent to this location by {subject_name}")
...
self_loop_description <- str_glue("Number of letters sent by {subject_name} within this city")
node_description       <- str_glue("Number of letters sent by {subject_name} to this location")
map_title               <- str_glue("Letters sent by {subject_name}: network view")
