...
data_path <- "../query_results/no_epp_per_loc/no_epp_per_loc_written_by_era_at_outliers.csv"
output_path <- "../r_plots/no_epp_per_loc/no_epp_per_loc_written_by_era_at_outliers_years_boxplot"

location_col <- "locations_name_modern"
year_col     <- "YEAR"
count_col    <- "COUNT"

measure_label <- str_glue("letters per year written by {subject_name} at")
