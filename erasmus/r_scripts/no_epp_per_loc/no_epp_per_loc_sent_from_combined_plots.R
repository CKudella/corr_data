...
data_path <- "../query_results/no_epp_per_loc/no_epp_per_loc_sent_from.csv"
output_path <- "../r_plots/no_epp_per_loc/no_epp_per_loc_sent_from_combined_plots"

measure_col  <- "Number of letters sent from this location"
