...
output_path <- "../r_plots/no_epp_per_loc/no_epp_per_loc_sent_by_era_to_outliers_years_boxplot"

location_col <- "locations_name_modern"
year_col     <- "YEAR"
count_col    <- "COUNT"

measure_label <- str_glue("letters per year sent by {subject_name} to")
