...
output_path <- "../r_plots/no_epp_per_loc/avg_no_epp_per_corr_loc_written_by_era_to_combined_plots"
...
plot_histogram <- data |>
  ...
  labs(
    ...
    x = str_glue("Average number of letters per correspondent (log-scale)"),
