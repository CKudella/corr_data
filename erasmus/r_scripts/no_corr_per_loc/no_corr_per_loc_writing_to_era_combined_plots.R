...
output_path <- "../r_plots/no_corr_per_loc/no_corr_per_loc_writing_to_era_combined_plots"
...
plot_histogram <- data |>
  ...
  labs(
    title = str_glue("Distribution of correspondents writing letters to {subject_name}, by location"),
