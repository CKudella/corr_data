...
data_path <- "../query_results/no_epp_per_modern_state/no_epp_per_modern_state_sent_from_era_to.csv"
output_path <- "../r_plots/no_epp_per_modern_state/no_epp_per_modern_state_sent_from_era_to_barchart"

measure_col <- str_glue("Number of letters {subject_name} sent to this modern state")
...
plot_barchart <- data |>
  ...
  labs(
    title = str_glue("Number of letters sent BY {subject_name} TO locations in each modern state"),
