...
# read data
data <- read.csv("no_corr_per_year/comp_no_corr_no_epp_per_year_to_era.csv", fileEncoding = "UTF-8", na.strings = c("NULL"))
...
plot3 <- ggplot(data = data3, aes(x = Number.of.correspondents.writing.letters.to.Erasmus.this.year, y = Number.of.letters.sent.to.Erasmus.this.year)) +
  geom_point() +
...
ggsave("comp_no_corr_no_epp_per_year_to_era_plots_combined.pdf", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("comp_no_corr_no_epp_per_year_to_era_plots_combined.png", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("comp_no_corr_no_epp_per_year_to_era_plots_combined.eps", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
ggsave("comp_no_corr_no_epp_per_year_to_era_plots_combined.svg", plot = last_plot(), scale = 1, width = 11.7, height = 8.3, units = "in", dpi = 600, limitsize = TRUE)
