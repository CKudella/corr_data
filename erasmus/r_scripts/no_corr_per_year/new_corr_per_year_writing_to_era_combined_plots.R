...
new_path    <- "../query_results/no_corr_per_year/new_corr_per_year_writing_to_era.csv"
total_path  <- "../query_results/no_corr_per_year/comp_no_corr_no_epp_per_year_to_era.csv"
output_path <- "../r_plots/no_corr_per_year/new_corr_per_year_writing_to_era_combined_plots"

new_measure_col   <- "NewCorrWritingToEra"
new_year_col      <- "YEAR"
total_measure_col <- str_glue("Number of correspondents writing letters to {subject_name} this year")
total_year_col    <- "Year"
