SELECT COUNT(correspondents_id) AS 'Total number of correspondents for whom the dataset contains only letters sent by them to Pirckheimer but not vice versa'
