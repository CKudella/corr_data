SELECT COUNT(locations.locations_name_modern) AS 'Total number of locations from which Pirckheimer has sent letters and from which he also received letters'
