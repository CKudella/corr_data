SELECT Y.locations_name_modern AS 'Location Name',
       ...
       X.count AS 'Number of years letters are written from this location to Pirckheimer',
       Y.count AS 'Number of letters written from this location to Pirckheimer',
       Y.COUNT/X.COUNT AS 'Average number of letters written from this location to Pirckheimer per year'
FROM
