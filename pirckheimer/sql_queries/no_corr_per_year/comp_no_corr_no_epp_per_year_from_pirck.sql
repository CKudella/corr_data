SELECT A.Year,
       A.NoCorrFromPirck AS 'Number of correspondents receiving letters from Pirckheimer this year',
       B.NoEppFromPirck AS 'Number of letters sent from Pirckheimer this year'
FROM
