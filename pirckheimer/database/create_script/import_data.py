...
CSV_FILES = [
    ("locations", "pirckheimer/dataset/csv/wpirck_locations.csv"),
    ("correspondents", "pirckheimer/dataset/csv/wpirck_correspondents.csv"),
    ("letters", "pirckheimer/dataset/csv/wpirck_letters.csv"),
]

# SQL script to create tables
SQL_SCRIPT_PATH = "pirckheimer/database/create_script/wpirck_cdb_v1_create_script.sql"
