...
duration_of_correspondence_only_epp_from_pirck$duration_in_years <- round(duration_of_correspondence_only_epp_from_pirck$duration_in_years, digits = 1)
...
# create scatter plot
plot <- ggplot(duration_of_correspondence_only_epp_from_pirck, aes(x = Beginning.of.the.correspondence ,y = duration_in_years)) +
...
ggsave("duration_of_correspondence_only_epp_from_pirck_scatterplot.pdf", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_pirck_scatterplot.png", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_pirck_scatterplot.eps", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
ggsave("duration_of_correspondence_only_epp_from_pirck_scatterplot.svg", plot = last_plot(), scale = 1, width = 33.1, height = 23.4, units = "in", dpi = 600, limitsize = TRUE)
