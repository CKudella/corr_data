...
duration_of_correspondence_only_epp_to_pirck <- read.csv("duration_of_correspondence/duration_corr_only_epp_to_erasmus.csv", fileEncoding = "UTF-8", colClasses = c("FLTE" = "Date", "LLTE" = "Date"))
