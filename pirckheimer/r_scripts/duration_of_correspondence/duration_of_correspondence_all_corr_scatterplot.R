...
plot <- ggplot(duration_of_correspondence_all_corr, aes(x = Beginning.of.correspondence.with.Pirckheimer ,y = duration_in_years)) +
  ...
  labs(y = "Duration of correspondence in years", x = "Beginning of the correspondence with Pirckheimer")
plot
