...
# create pointplot
plot <- ggplot(data = data, aes(x = reorder(recipient_id, -Number.of.letters.sent.by.Pirckheimer.to.this.correspondent), y = Number.of.letters.sent.by.Pirckheimer.to.this.correspondent, label = recipient_id)) +
