...
num_breaks <- 3
breaks <- classIntervals(data$Number.of.Letters.sent.from.this.location.by.Pirckheimer, n = num_breaks, style = "jenks")$brks
...
data$class <- findInterval(data$Number.of.Letters.sent.from.this.location.by.Pirckheimer, breaks, rightmost.closed = TRUE)
...
saveWidget(m, file = "no_epp_per_loc_written_by_pirck_at_with_geocoordiantes_colour.html", selfcontained = TRUE)
