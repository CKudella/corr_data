...
num_breaks <- 3
breaks <- classIntervals(data$Number.of.correspondents.who.wrote.from.this.location.letters.to.Pirckheimer, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_corr_per_loc_writing_to_pirck_with_geocoordinates_colour.html", selfcontained = TRUE)
