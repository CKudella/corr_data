...
num_breaks <- 4
breaks <- classIntervals(data$Number.of.correspondents.who.received.at.this.Location.letters.from.Pirckheimer, n = num_breaks, style = "jenks")$brks
...
saveWidget(m, file = "no_corr_per_loc_receiving_from_pirck_with_geocoordinates_colour.html", selfcontained = TRUE)
