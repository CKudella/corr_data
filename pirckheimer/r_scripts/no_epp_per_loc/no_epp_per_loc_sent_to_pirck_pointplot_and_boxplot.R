...
plot2 <- ggplot(data, aes(x = " ", y = Number.of.letters.sent.from.this.location.to.Pirckheimer)) +
  ...
  geom_text_repel(box.padding = 1.75, label = ifelse(data$Number.of.letters.sent.from.this.location.to.Pirckheimer >= upper_dots, as.character(data$Location.Name), "")) +
  theme_bw() +
