...
# read data for no epp per loc written by pirck to
data_epp<-read.csv("no_epp_per_loc/no_epp_per_loc_sent_by_pirck_to.csv", fileEncoding="UTF-8", na.strings=c("NULL"))
...
data_epp_outlier <- subset(data_epp, data_epp$Number.of.letters.sent.to.this.location.by.Pirckheimer >= 11)
