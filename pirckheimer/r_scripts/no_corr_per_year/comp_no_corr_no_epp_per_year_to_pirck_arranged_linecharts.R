...
plot <- ggplot(data=data, aes(x= Year, y=Number.of.correspondents.writing.letters.to.Pirckheimer.this.year)) +
...
plot2 <- ggplot(data=data, aes(x= Year, y=Number.of.letters.sent.to.Pirckheimer.this.year)) +
  geom_line(stat = "identity", size=0.9) +
