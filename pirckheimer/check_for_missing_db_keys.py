...
correspondents_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/wpirck_correspondents.csv'))
letters_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/wpirck_letters.csv'))
locations_df = pd.read_csv(os.path.join(base_path, 'dataset/csv/wpirck_locations.csv'))
